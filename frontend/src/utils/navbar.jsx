  ...
  return (
    <div className="fixed w-[100vw] flex items-center justify-center sms:justify-between sms:p-2 bg-baseprimary px-4 z-50 transition-all duration-300">
      ...
      <div className="hidden lgs:flex mds:flex  items-center justify-center w-[20vw] h-auto">
        <h2
          className="font-russoone text-primary text-2xl"
      ...
      <div className="hidden lgs:flex mds:flex w-[20vw] items-center justify-stretch"></div>

      <div
        className="mds:hidden lgs:hidden items-end sms:pl-3"
        onClick={handleNav}
      >
        <h2
          className="font-russoone text-primary text-2xl"
      ...
      <div
        className={`fixed left-0 top-0 sms:w-[80vw] mds:w-[80vw] h-full border-r rounded-r-2xl border-r-gray-400 bg-baseprimary transition-transform duration-500 ${
      ...
      >
        <ul className="p-4 font-russoone text-primary items-center justify-center">
          ...
          <li className="p-4 border-b border-gray-600 text-center">
            <Link to="/reviews" onClick={handleNav}>
              Services
            </Link>
          </li>
          <li className="p-4 border-b border-gray-600 text-center">
            <Link to="/articles" onClick={handleNav}>
              Cancer Care
            </Link>
          </li>
          <li className="p-4 border-b border-gray-600 text-center">
        ...
        <div className="flex items-center justify-center p-4 gap-4">
          <span className="text-gray-400 hover:text-primary transition-transform cursor-pointer"></span>
          <span className="text-gray-400 hover:text-primary transition-transform cursor-pointer"></span>
          <span className="text-gray-400 hover:text-primary transition-transform cursor-pointer"></span>
          <span className="text-gray-400 hover:text-primary transition-transform cursor-pointer"></span>
        </div>
