...
const SideItemBar = () => {
  return (
    <div
      className="fixed lgs:bottom-8 lgs:w-[35vw] lgs:h-[5rem] sms:flex items-center rounded-full justify-center bg-blue-400 z-40 transition-all duration-300"
      style={{
      ...
      <div className="flex items-center justify-center lgs:h-[5rem] space-x-5">
        ...
        <Link to="/profile">
          <div className="flex h-auto w-[9vw] items-center justify-center rounded-full space-x-2 cursor-pointer hover:scale-110 transition-transform duration-300 ease-in-out">
            <FontAwesomeIcon
              icon={faCircleUser}
              className="h-8 text-primary lgs:pl-2"
            />
            <h2 className="text-primary font-ibmplexsans text-md">
              Profile Details
            </h2>
          </div>
        </Link>
